...
// example usage:
revealPath({ direction: "SouthEast", distance: 5000 });
...
// example usage:
castSpell(["Phoenix Feather", "Dragon Scale"]);
...
const { outer: { inner: secret } } = nestedSecret;
console.log(`The Final Key: ${secret}`);
